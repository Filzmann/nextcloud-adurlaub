...
for (const contract of ["script('adurlaub', 'components/vacation-plan')", "script('adurlaub', 'modules/vacation-app')", "script('adurlaub', 'main')"]) if (!template.includes(contract)) throw new Error(`Skript-Reihenfolge fehlt: ${contract}`);
