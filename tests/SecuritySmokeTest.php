...
if (preg_match('/#\[NoCSRFRequired\]\s+(?:#\[NoAdminRequired\]\s+)?public function (create|update|delete)/', $controller)) throw new RuntimeException('Schreibender Urlaubs-Endpunkt umgeht CSRF-Schutz.');
